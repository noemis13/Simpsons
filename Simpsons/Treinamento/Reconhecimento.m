...
vetCaracteristicaASCII = fopen('VetorTreina.txt','w');

Numero_Exemplos_Bart = 78;
Numero_Exemplos_Homer = 61;
Numero_Exemplos_Lisa = 33;
Numero_Exemplos_Meggie = 30;
Numero_Exemplos_Marge = 24;
